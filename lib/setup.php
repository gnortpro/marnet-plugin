...
function register_mysettings() {
	...
	register_setting( 'mfpd-settings-group', 'giatriid1Adwords' );

	register_setting( 'mfpd-settings-group', 'id2' );

	register_setting( 'mfpd-settings-group', 'giatriid2' );	register_setting( 'mfpd-settings-group', 'giatriid22' );

	register_setting( 'mfpd-settings-group', 'id3' );

	register_setting( 'mfpd-settings-group', 'giatriid3' ); register_setting( 'mfpd-settings-group', 'giatriid33' );

	register_setting( 'mfpd-settings-group', 'id4' );

	register_setting( 'mfpd-settings-group', 'giatriid4' ); register_setting( 'mfpd-settings-group', 'giatriid44' );

	register_setting( 'mfpd-settings-group', 'id5' );

	register_setting( 'mfpd-settings-group', 'giatriid5' ); register_setting( 'mfpd-settings-group', 'giatriid55' );

	register_setting( 'mfpd-settings-group', 'id6' );

	register_setting( 'mfpd-settings-group', 'giatriid6' ); register_setting( 'mfpd-settings-group', 'giatriid66' );

	register_setting( 'mfpd-settings-group', 'id7' );

	register_setting( 'mfpd-settings-group', 'giatriid7' ); register_setting( 'mfpd-settings-group', 'giatriid77' );

	register_setting( 'mfpd-settings-group', 'id8' );

	register_setting( 'mfpd-settings-group', 'giatriid8' ); register_setting( 'mfpd-settings-group', 'giatriid88' );

	register_setting( 'mfpd-settings-group', 'id9' );

	register_setting( 'mfpd-settings-group', 'giatriid9' ); register_setting( 'mfpd-settings-group', 'giatriid99' );

	register_setting( 'mfpd-settings-group', 'id10' );

	register_setting( 'mfpd-settings-group', 'giatriid10' ); register_setting( 'mfpd-settings-group', 'giatriid1010' );

	register_setting( 'mfpd-settings-group', 'id11' );

	register_setting( 'mfpd-settings-group', 'giatriid11' ); register_setting( 'mfpd-settings-group', 'giatriid1111' );

	register_setting( 'mfpd-settings-group', 'id12' );

	register_setting( 'mfpd-settings-group', 'giatriid12' ); register_setting( 'mfpd-settings-group', 'giatriid1212' );

	register_setting( 'mfpd-settings-group', 'id13' );

	register_setting( 'mfpd-settings-group', 'giatriid13' ); register_setting( 'mfpd-settings-group', 'giatriid1313' );

	register_setting( 'mfpd-settings-group', 'id14' );

	register_setting( 'mfpd-settings-group', 'giatriid14' ); register_setting( 'mfpd-settings-group', 'giatriid1414' );

	register_setting( 'mfpd-settings-group', 'id15' );

	register_setting( 'mfpd-settings-group', 'giatriid15' ); register_setting( 'mfpd-settings-group', 'giatriid1515' );

	register_setting( 'mfpd-settings-group', 'id16' );

	register_setting( 'mfpd-settings-group', 'giatriid16' ); register_setting( 'mfpd-settings-group', 'giatriid1616' );

	register_setting( 'mfpd-settings-group', 'id17' );

	register_setting( 'mfpd-settings-group', 'giatriid17' ); register_setting( 'mfpd-settings-group', 'giatriid1717' );

	register_setting( 'mfpd-settings-group', 'id18' );

	register_setting( 'mfpd-settings-group', 'giatriid18' ); register_setting( 'mfpd-settings-group', 'giatriid1818' );

	register_setting( 'mfpd-settings-group', 'id19' );

	register_setting( 'mfpd-settings-group', 'giatriid19' ); register_setting( 'mfpd-settings-group', 'giatriid1919' );

	register_setting( 'mfpd-settings-group', 'id20' );

	register_setting( 'mfpd-settings-group', 'giatriid20' ); register_setting( 'mfpd-settings-group', 'giatriid2020' );

	register_setting( 'mfpd-settings-group', 'id21' );

	register_setting( 'mfpd-settings-group', 'giatriid21' ); register_setting( 'mfpd-settings-group', 'giatriid2121' );

	register_setting( 'mfpd-settings-group', 'id22' );

	register_setting( 'mfpd-settings-group', 'giatriid22_fix' ); register_setting( 'mfpd-settings-group', 'giatriid2222' );

	register_setting( 'mfpd-settings-group', 'id23' );

	register_setting( 'mfpd-settings-group', 'giatriid23' ); register_setting( 'mfpd-settings-group', 'giatriid2323' );

	register_setting( 'mfpd-settings-group', 'idtrangthanhtoan');

	register_setting( 'mfpd-settings-group', 'giatriidthanhtoanthanhcong' ); register_setting( 'mfpd-settings-group', 'giatriidthanhtoanthanhconggg' );

	register_setting( 'mfpd-settings-group', 'giatriidthanhtoanthanhkhongcong' ); register_setting( 'mfpd-settings-group', 'giatriidthanhtoanthanhkhongconggg' );

	register_setting( 'mfpd-settings-group', 'idconlai' ); register_setting( 'mfpd-settings-group', 'idconlaigg' );

	register_setting( 'mfpd-settings-group', 'all1' );

	register_setting( 'mfpd-settings-group', 'all2' );

	register_setting( 'mfpd-settings-group', 'all3' );

	register_setting( 'mfpd-settings-group', 'allh1' );

	register_setting( 'mfpd-settings-group', 'allh2' );

	register_setting( 'mfpd-settings-group', 'allh3' );

	register_setting( 'mfpd-settings-group', 'sotags' );

	register_setting( 'mfpd-settings-group', 'facebook_link' );

	register_setting( 'mfpd-settings-group', 'on_off_face');

	register_setting( 'mfpd-settings-group', 'tuy-bien-css');

	register_setting( 'mfpd-settings-group', '404_to_home');

	register_setting( 'mfpd-settings-group', 'email_admin_if');

	register_setting( 'mfpd-settings-group', 'tat_mo_plugin');

	register_setting( 'mfpd-settings-group', 'tat_mo_updates');

	register_setting( 'mfpd-settings-group', 'code_function');



	register_setting( 'mfpd-settings-group', 'custom_templates');

	register_setting( 'mfpd-settings-group', 'move_page_404');

	register_setting( 'mfpd-settings-group', 'php_in_function');

	register_setting( 'mfpd-settings-group', 'hien_thi_tags');

	register_setting( 'mfpd-settings-group', 'bat_shortcode');

	register_setting( 'mfpd-settings-group', 'sd1');

	register_setting( 'mfpd-settings-group', 'conshortcode1');

	register_setting( 'mfpd-settings-group', 'shortcode1');

	register_setting( 'mfpd-settings-group', 'sd2');

	register_setting( 'mfpd-settings-group', 'conshortcode2');

	register_setting( 'mfpd-settings-group', 'shortcode2');

	register_setting( 'mfpd-settings-group', 'sd3');

	register_setting( 'mfpd-settings-group', 'conshortcode3');

	register_setting( 'mfpd-settings-group', 'shortcode3');

	register_setting( 'mfpd-settings-group', 'sd4');

	register_setting( 'mfpd-settings-group', 'conshortcode4');

	register_setting( 'mfpd-settings-group', 'shortcode4');

	register_setting( 'mfpd-settings-group', 'sd5');

	register_setting( 'mfpd-settings-group', 'conshortcode5');

	register_setting( 'mfpd-settings-group', 'shortcode5');

	register_setting( 'mfpd-settings-group', 'sd6');

	register_setting( 'mfpd-settings-group', 'conshortcode6');

	register_setting( 'mfpd-settings-group', 'shortcode6');

	register_setting( 'mfpd-settings-group', 'sd7');

	register_setting( 'mfpd-settings-group', 'conshortcode7');

	register_setting( 'mfpd-settings-group', 'shortcode7');

	register_setting( 'mfpd-settings-group', 'mobile_detect');

	register_setting( 'mfpd-settings-group', 'tat_menu_ql');

	register_setting( 'mfpd-settings-group', 'tb_sua_chua');

	register_setting( 'mfpd-settings-group', 'hien_thi_thongbao');
...
function mfpd_create_menu() {
	...
	add_menu_page('MarNET Plugin Settings', 'MarNET Settings', 'administrator', __FILE__, 'mfpd_settings_page',plugins_url('../images/icon.png', __FILE__), 1);
